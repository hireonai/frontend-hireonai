    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-r from-[#163756] via-[#202838] via-[#3E98A1] to-[#163756] text-white flex-col justify-center items-center text-white p-12">
        <div className="max-w-md text-center">
          ...
          <h1 className="text-4xl font-bold mb-4">Join HireOn.AI</h1>
          ...
          <CardContent className="space-y-6">
            <form className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="username" type="text" placeholder="Choose a username" className="h-12" />
              </div>

              <div className="space-y-2">
                <Label htmlFor="fullName">Full Name</Label>
                <Input id="fullName" type="text" placeholder="Enter your full name" className="h-12" />
              </div>
              ...
              <Button className="w-full h-12 bg-[#163756] hover:bg-white hover:text-[#163756] text-white">Register</Button>
            </form>
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link href="/login" className="text-[#4A90A4] hover:underline font-medium">
                  Sign In
                </Link>
              </p>
            </div>
